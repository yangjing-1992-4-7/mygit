...
class Attachment extends Model
{
    ...
    {   
    	$piblic = config('public_url') . 'uploads/';
        $uploadPath = config('upload_path');
        $watermark_img=$uploadPath.DIRECTORY_SEPARATOR.str_replace($piblic,'',$watermark_img);
        $thumb_water_pic=str_replace('/',DIRECTORY_SEPARATOR,$watermark_img);
