<?php /*a:3:{s:71:"E:\UPUPW_AP7.0_64\htdocs\yzn\application\admin\view\config\setting.html";i:1556073810;s:69:"E:\UPUPW_AP7.0_64\htdocs\yzn\application\admin\view\index_layout.html";i:1604474802;s:66:"E:\UPUPW_AP7.0_64\htdocs\yzn\application\admin\view\inputItem.html";i:1615280474;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="js-upload-image">
            <div id="file_list_<?php echo htmlentities($vo['name']); ?>" class="uploader-list">
                ...
                <div class="file-item thumbnail">
                    <img data-original="<?php echo htmlentities(get_file_path($vo['value'])); ?>" src="<?php echo htmlentities((get_file_path($vo['value']) ?: '/yzn/public/static/admin/img/none.png')); ?>" width="100" style="max-height: 100px;">
                    <i class="iconfont icon-delete_fill remove-picture" data-id="<?php echo htmlentities($vo['value']); ?>"></i>                   
                </div>
                <?php endif; ?>
            </div>
            <input type="hidden" name="<?php echo htmlentities($vo['fieldArr']); ?>[<?php echo htmlentities($vo['name']); ?>]" data-multiple="false" data-watermark='0' data-thumb='' data-size="<?php echo config('upload_image_size'); ?>" data-ext="<?php echo config('upload_image_ext'); ?>" id="<?php echo htmlentities($vo['name']); ?>" value="<?php echo htmlentities((isset($vo['value']) && ($vo['value'] !== '')?$vo['value']:'')); ?>">
            <div class="layui-clear"></div>
            <div id="picker_<?php echo htmlentities($vo['name']); ?>"><i class="layui-icon layui-icon-upload"></i> 上传图片</div>
            <!--<div class="js-upload-image">
    ...
    <div class="layui-form-field-label">
        <div class="js-upload-images">
            <div id="file_list_<?php echo htmlentities($vo['name']); ?>" class="uploader-list">
                ...
                <div class="file-item thumbnail">
                    <img data-original="<?php echo htmlentities(get_file_path($v)); ?>" src="<?php echo htmlentities((get_file_path($v) ?: '/yzn/public/static/admin/img/none.png')); ?>" width="100" style="max-height: 100px;">
            ...
            <input type="hidden" name="<?php echo htmlentities($vo['fieldArr']); ?>[<?php echo htmlentities($vo['name']); ?>]" data-multiple="true" data-watermark='0' data-thumb='' data-size="<?php echo config('upload_image_size'); ?>" data-ext="<?php echo config('upload_image_ext'); ?>" id="<?php echo htmlentities($vo['name']); ?>" value="<?php echo htmlentities((isset($vo['value']) && ($vo['value'] !== '')?$vo['value']:'')); ?>">
            <div class="layui-clear"></div>
...
<script type="text/javascript" src="/yzn/public/static/libs/webuploader/webuploader.min.js"></script>
<script type="text/javascript" src="/yzn/public/static/libs/Sortable.js"></script>
<script type="text/javascript" src="/yzn/public/static/libs/viewer/viewer.min.js"></script>
<script type="text/javascript" src="/yzn/public/static/admin/js/form.js"></script>
<link rel="stylesheet" href="/yzn/public/static/libs/viewer/viewer.min.css">
<link rel="stylesheet" href="/yzn/public/static/libs/webuploader/webuploader.css">
<script type="text/javascript">
