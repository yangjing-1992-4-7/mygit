<?php /*a:2:{s:75:"E:\UPUPW_AP7.0_64\htdocs\yzn\application\admin\view\auth_manager\index.html";i:1604755868;s:69:"E:\UPUPW_AP7.0_64\htdocs\yzn\application\admin\view\index_layout.html";i:1604474802;}*/ ?>
<!DOCTYPE html>
<html>
...
layui.use('table', function() {
    ...
    table.render({
        ...
        cols: [
            [
                { field: 'title',width: 200, title: '授权',templet: "<div>{{#  if(d.id!=1){ }} <a class='layui-btn layui-btn-xs' href='<?php echo url('AuthManager/access?group_name='); ?>?title={{d.title}}&group_id={{d.id}}'>访问授权</a> {{#  } else { }}  {{#  } }}</div>" },
