!function(a, u, y, d) {
    ...
    function h(t, i) {
        ...
        for (var s in this.$layers = this.$context.find("." + this.filterClass),
        e)
            null === e[s] && delete e[s];
        a.extend(this, r, i, e),
    ...
    h.prototype.transformSupport = function(t) {
        for (var i = y.createElement("div"), e = !1, s = null, n = !1, o = null, a = null, r = 0, h = this.vendors.length; r < h; r++)
            if (a = null !== this.vendors[r] ? (o = this.vendors[r][0] + "transform",
            this.vendors[r][1] + "Transform") : o = "transform",
            i.style[a] !== d) {
                e = !0;
                break
            }
        ...
        case "3D":
            if (e) {
                var l = y.body || y.createElement("body")
                  , p = y.documentElement
                  , c = p.style.overflow
                  , m = !1;
                y.body || (m = !0,
                ...
                n = (s = u.getComputedStyle(i).getPropertyValue(o)) !== d && 0 < s.length && "none" !== s,
                p.style.overflow = c,
                l.removeChild(i),
                m && (l.removeAttribute("style"),
    ...
    h.prototype.motionSupport = !!u.DeviceMotionEvent,
    h.prototype.orientationSupport = !!u.DeviceOrientationEvent,
    ...
    h.prototype.updateLayers = function() {
        this.$layers = this.$context.find("." + this.filterClass),
        this.depthsX = [],
        this.depthsY = [],
        this.$layers.css({
            position: "absolute"
        ...
        this.$layers.each(a.proxy(function(t, i) {
            var e = a(i).data("distance") || 0
              , s = 0 == (a(i).data("direction") || 0) ? "-" : "+";
            this.depthsX.push(parseFloat(s + e)),
            this.depthsY.push(parseFloat(s + e))
        }, this))
    }
    ,
    ...
    ,
    h.prototype.queueCalibration = function(t) {
    ...
    ,
    h.prototype.accelerate = function(t) {
        for (var i = 0, e = t.length; i < e; i++) {
            var s = t[i];
            this.css(s, "transform", "translate(0,0)")
        }
    }
    ,
    h.prototype.setPosition = function(t, i, e) {
        i += "px",
        e += "px",
        this.transform3DSupport ? this.css(t, "transform", "translate(" + i + "," + e + ")") : this.transform2DSupport ? this.css(t, "transform", "translate(" + i + "," + e + ")") : (t.style.left = i,
        t.style.top = e)
    }
    ,
    h.prototype.onOrientationTimer = function(t) {
        this.orientationSupport && 0 === this.orientationStatus && (this.disable(),
        this.orientationSupport = !1,
        this.enable())
    }
    ,
    h.prototype.onCalibrationTimer = function(t) {
        this.calibrationFlag = !0
    }
    ,
    h.prototype.onWindowResize = function(t) {
        this.updateDimensions()
    }
    ,
    ...
    a.fn[n] = function(e) {
        ...
        return this.each(function() {
            ...
            i || (i = new h(this,e),
            t.data(n, i)),
            l[e] && i[e].apply(i, Array.prototype.slice.call(s, 1))
        })
    }
}(window.jQuery || window.Zepto, window, document),
function() {
    for (var o = 0, t = ["ms", "moz", "webkit", "o"], i = 0; i < t.length && !window.requestAnimationFrame; ++i)
