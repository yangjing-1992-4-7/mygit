...
!function(e) {
    ...
    var c, m, e = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], t = "onwheel"in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], g = Array.prototype.slice;
    if (d.event.fixHooks)
    ...
    function o(e) {
        ...
        "axis"in t && t.axis === t.HORIZONTAL_AXIS && (i = -1 * l,
        l = 0),
        o = 0 === l ? i : l,
        "deltaY"in t && (o = l = -1 * t.deltaY),
        ...
        0 !== l || 0 !== i) {
            ...
            if (s = Math.max(Math.abs(l), Math.abs(i)),
            (!m || s < m) && v(t, m = s) && (m /= 40),
            v(t, s) && (o /= 40,
            i /= 40,
            l /= 40),
