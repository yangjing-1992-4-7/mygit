...
use app\attachment\controller\Upload as Upload;
...
class Ueditor extends Attachments
{
    ...
    {   
        ...
        switch ($action) {
            ...
            /* 上传图片 */
            case 'uploadimage':
                return $upload->saveFile('images', 'ueditor');
                break;
            /* 上传涂鸦 */
            case 'uploadscrawl':
                return $upload->saveFile('images', 'ueditor_scrawl');
                break;
            /* 上传视频 */
            case 'uploadvideo':
                return $upload->saveFile('videos', 'ueditor');
                break;
            /* 上传附件 */
            case 'uploadfile':
                return $upload->saveFile('files', 'ueditor');
                break;
            /* 列出图片 */
            case 'listimage':
